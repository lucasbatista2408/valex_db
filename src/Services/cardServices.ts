...
import { findByTypeAndEmployeeId, findByCardDetails } from "../Repositories/cardRepository";
...
export async function checkByType(type, employeeId:number){
...
export function checkIfPassExists(password){
